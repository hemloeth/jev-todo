...
export const QUESTIONS = {
  is_task: {
    type: "noul",
    instructions: "Is note an actionable task or to-do the writer must do, rather than an idea or fact? (Evaluates English, Hindi, and Hinglish tasks such as 'karna hai', 'pdhna hai / padhna hai', 'bhejna hai', 'dena hai', etc.)",
  },
  priority: {
    type: "score",
    instructions: "How urgent is note given today? (Evaluates English, Hindi, and Hinglish urgency terms like 'aj / aaj' [today], 'kal' [tomorrow], 'jaldi / turant' [urgent], etc.)",
    criteria: [
  ...
  deadline: {
    type: "choice",
    instructions: "Which date is the deadline for note? (Supports English, Hindi, and Hinglish dates like 'aj / aaj' [today], 'kal' [tomorrow], 'parso', 'agle hafte' [next week], etc.)",
